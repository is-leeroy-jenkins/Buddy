...
budget execution data, and a vectorized data set of financial policy documents. Buddy is integrated with **GPT-5.2**, **Grok**, **Gemini**, and has been **fine-tuned** on datasets 
